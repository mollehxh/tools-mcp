...
local services, write inside the selected workspace, and durably install
project or global skills. Use synthetic credentials and a disposable macOS
profile. Do not expose a personal home directory or a production workstation.
...
the URL is not a credential and must never be treated as secret authentication.
